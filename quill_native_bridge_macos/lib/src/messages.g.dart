...
class QuillNativeBridgeApi {
  ...
  Future<void> copyTextToClipboard(String text) async {
    final pigeonVar_channelName =
        'dev.flutter.pigeon.quill_native_bridge_macos.QuillNativeBridgeApi.copyTextToClipboard$pigeonVar_messageChannelSuffix';
    final pigeonVar_channel = BasicMessageChannel<Object?>(pigeonVar_channelName, pigeonChannelCodec, binaryMessenger: pigeonVar_binaryMessenger);
  ...
  Future<String?> getClipboardMarkdown() async {
    final pigeonVar_channelName =
        'dev.flutter.pigeon.quill_native_bridge_macos.QuillNativeBridgeApi.getClipboardMarkdown$pigeonVar_messageChannelSuffix';
    final pigeonVar_channel = BasicMessageChannel<Object?>(pigeonVar_channelName, pigeonChannelCodec, binaryMessenger: pigeonVar_binaryMessenger);
    final Future<Object?> pigeonVar_sendFuture = pigeonVar_channel.send(null);
    final pigeonVar_replyList = await pigeonVar_sendFuture as List<Object?>?;
  ...
  Future<void> copyMarkdownToClipboard(String markdown) async {
    final pigeonVar_channelName =
        'dev.flutter.pigeon.quill_native_bridge_macos.QuillNativeBridgeApi.copyMarkdownToClipboard$pigeonVar_messageChannelSuffix';
    final pigeonVar_channel = BasicMessageChannel<Object?>(pigeonVar_channelName, pigeonChannelCodec, binaryMessenger: pigeonVar_binaryMessenger);
