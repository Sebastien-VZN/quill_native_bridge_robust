...
void main() {
  group('constructWindowsHtmlDescriptionHeaders', () {
    test('should include windows descirption headers', () {
      const htmlInput = '<body>This is normal. <b>This is bold.</b> <i><b>This is bold italic.</b> This is italic.</i></body>';
...
''';
      expect(constructWindowsHtmlDescriptionHeaders(htmlInput), expectedWindowsHtml);
    });
  });
}
