...
private object GeneratedMessagesPigeonUtils {
...
interface QuillNativeBridgeApi {
  ...
  fun getClipboardMarkdown(): String?
  fun copyMarkdownToClipboard(markdown: String)
  ...
  companion object {
    ...
    fun setUp(binaryMessenger: BinaryMessenger, api: QuillNativeBridgeApi?, messageChannelSuffix: String = "") {
        ...
        if (api != null) {
          channel.setMessageHandler { _, reply ->
            val wrapped: List<Any?> = try {
              ...
              GeneratedMessagesPigeonUtils.wrapError(exception)
            }
            reply.reply(wrapped)
          }
        } else {
      ...
      run {
        val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.quill_native_bridge_android.QuillNativeBridgeApi.getClipboardText$separatedMessageChannelSuffix", codec)
        if (api != null) {
          channel.setMessageHandler { _, reply ->
            val wrapped: List<Any?> = try {
      ...
      run {
        val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.quill_native_bridge_android.QuillNativeBridgeApi.copyTextToClipboard$separatedMessageChannelSuffix", codec)
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            val args = message as List<Any?>
            val textArg = args[0] as String
            val wrapped: List<Any?> = try {
              api.copyTextToClipboard(textArg)
              listOf(null)
            } catch (exception: Throwable) {
              GeneratedMessagesPigeonUtils.wrapError(exception)
            }
      ...
      run {
        val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.quill_native_bridge_android.QuillNativeBridgeApi.getClipboardMarkdown$separatedMessageChannelSuffix", codec)
        if (api != null) {
          channel.setMessageHandler { _, reply ->
            val wrapped: List<Any?> = try {
              listOf(api.getClipboardMarkdown())
            } catch (exception: Throwable) {
              GeneratedMessagesPigeonUtils.wrapError(exception)
            }
            reply.reply(wrapped)
      ...
      run {
        val channel = BasicMessageChannel<Any?>(binaryMessenger, "dev.flutter.pigeon.quill_native_bridge_android.QuillNativeBridgeApi.copyMarkdownToClipboard$separatedMessageChannelSuffix", codec)
        if (api != null) {
          channel.setMessageHandler { message, reply ->
            val args = message as List<Any?>
            val markdownArg = args[0] as String
            val wrapped: List<Any?> = try {
              api.copyMarkdownToClipboard(markdownArg)
              listOf(null)
            } catch (exception: Throwable) {
              GeneratedMessagesPigeonUtils.wrapError(exception)
            }
